...
$query = "SELECT * FROM `cois3420_cravings_recipes`"; 
    ...
    <div class="homePageContainer"> 
        <div class="navContainer1">
            <nav id="nav1">
                ...
                <a href="user_homepage.php?logout='1'"><i class="fas fa-sign-out-alt"></i> Log Out</a>
            </nav>
        </div>
            ...
            ?>
                <div class="homeUserPost" id="userPost">
                        ...
                        <div class="homePostUsername"> 
                            ...
                            <p id="postUsername"><?php echo $uname?></p>
                        ...
                        <div class="userPostOptions" id="<?php echo $id?>">
